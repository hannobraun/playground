...
fn drop0_drops_operand_at_index_0() {
    let mut program = Application::compile_and_run("3 5 8 drop0");
...
fn drop1_drops_operand_at_index_1() {
    let mut program = Application::compile_and_run("3 5 8 drop1");
...
fn drop2_drops_operand_at_index_2() {
    let mut program = Application::compile_and_run("3 5 8 drop2");
...
fn pick0_picks_operand_at_index_0() {
    let mut program = Application::compile_and_run("3 5 8 pick0");
...
fn pick1_picks_operand_at_index_1() {
    let mut program = Application::compile_and_run("3 5 8 pick1");
...
fn pick2_picks_operand_at_index_2() {
    let mut program = Application::compile_and_run("3 5 8 pick2");
...
fn roll2_should_rotate_the_top_2_operands() {
    let mut program = Application::compile_and_run("2 3 5 8 roll2");
...
fn roll3_should_rotate_the_top_3_operands() {
    let mut program = Application::compile_and_run("2 3 5 8 roll3");
...
fn roll4_should_rotate_the_top_4_operands() {
    let mut program = Application::compile_and_run("2 3 5 8 roll4");
...
fn popping_from_empty_stack_triggers_effect() {
    let mut program = Application::compile_and_run("drop0");
